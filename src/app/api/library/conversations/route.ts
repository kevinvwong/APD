...
//   POST   → create a new conversation { fm_id?, title?, mode? } → { id }
//   DELETE → remove ?id=N
...
export const GET = withApiError("library/conversations GET", async () => {
